...
ribs, with complications.")
  ...
  (define-argument a1 (pro 8-years (pr bodily-harm) (pr bodily-harm-rule)))
  ...
  (define-argument a6 (con testimony-of-the-accused (pr 10-witnesses)))
  ...
  (define c1 (accept default-context  (list 10-witnesses hospital-report lex-specialis)))
