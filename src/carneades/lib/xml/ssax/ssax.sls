(library
 ...
 (import
  ...
  (only (rnrs io simple)
        peek-char read-char        
        close-input-port eof-object?)

  (only (rnrs io ports)
        open-string-input-port)
  
  (only (rnrs lists)
        assq assoc member memv)
  ...
  (only (carneades lib  xml ssax look-for-str)
        find-string-from-port?)
  
  (only (carneades lib  xml ssax char-encoding)
        ascii->char ucscode->char char-return)
  
  (only (carneades lib  xml ssax input-parse)
