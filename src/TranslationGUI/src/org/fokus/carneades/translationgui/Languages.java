...
public class Languages {
    ...
    public List<String> listAllLangValues() {
        List<String> reprList = new ArrayList<String>();        
        Set<String> reprSet = this.langRepresentations.keySet();        
        for(String r : reprSet) {
            reprList.add(r);
        }
        Collections.sort(reprList);
        return reprList;
    }
    
    public List<String> listAllLangRepresentations() {
        List<String> valList = new ArrayList<String>();        
        Set<String> valSet = this.langValues.keySet();        
        for(String r : valSet) {
            valList.add(r);
        }
