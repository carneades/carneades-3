 ...
 * @author stb
 */
public class PolicyEvaluation extends HttpServlet {
    
    private static final Logger log = LoggerFactory.getLogger(PolicyEvaluation.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CarneadesService service = new CarneadesServiceManager();
