...
package org.fokus.carneades.servlets;
...
import org.fokus.carneades.common.CarneadesException;
import org.fokus.carneades.api.CarneadesMessage;
import org.fokus.carneades.api.MessageType;
import org.fokus.carneades.api.Statement;
import org.fokus.carneades.engine.CarneadesService;
import org.fokus.carneades.engine.CarneadesServiceManager;
 ...
 * @author stb
 */
public class PolicySimulation extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger(PolicySimulation.class);
    ...
    throws ServletException, IOException {
        try {
            ...
            if (service == null) {
                ...
                service = new CarneadesServiceManager();
