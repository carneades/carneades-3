...
(ns carneades.resources.public.kb.copyright-policies
...
(def copyright-policies 
  (make-theory
   ...
   {'announcement-category
    (make-individual :symbol 'announcement :text {:en "Announcement" :de "Bekanntmachung"})
    ...
    ;; 'yes (make-individual :symbol 'standard :text {:en "Yes"})
    ;; 'no (make-individual :symbol 'standard :text {:en "No"})
    ;; 'maybe (make-individual :symbol 'standard :text {:en "Maybe"})
    'public (make-individual :symbol 'standard :text {:en "Public"})
