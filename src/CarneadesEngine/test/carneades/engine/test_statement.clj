...
(deftest test-statement-atom
  ...
  (is (= '(x ?r1 ?r2) (literal-atom (make-statement :atom '(not (x ?r1 ?r2)))))))

(deftest test-literal->str
  (is (= "(undercut urn:uuid:9149f01d-a538-4729-abfc-a5be3e724f85)"
         (literal->str (map->statement '{:atom (undercut urn:uuid:9149f01d-a538-4729-abfc-a5be3e724f85), :header nil, :positive true, :weight nil, :main false, :standard :pe, :text {}, :con #{}, :pro #{urn:uuid:cbfe61db-fc63-4597-918b-8984334ade6b}, :premise-of #{}, :value 1.0, :id urn:uuid:5ac4f0ff-22f1-4fa2-9180-ad63698bd938}) true)
)))