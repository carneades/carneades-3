...
(defn literal? [x] (throw (Exception. "NYI")))
(defn apply-substitutions [x] (throw (Exception. "NYI")))
(defn literal->statement [x] (throw (Exception. "NYI")))
(defn make-argument [x] (throw (Exception. "NYI")))
