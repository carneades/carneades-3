...
(ns carneades.examples.piersonpost2
...
(def chased-by-big-dogs 
  "The fox was being chased by large hounds.")

(def deemed-mortally-wounded 
  "A noxious animal being chased by large hounds shall be deemed mortally wounded.")

(def protecting-farmers 
  "Protecting farmers is an important social value.")

(def encourage-hunting    ; policy/action
  "Encouraging hunting helps protect farmers from noxious animals.")

(def foxes-are-noxious
  "Foxes are noxious animals.")

(def admitted-in-the-pleadings
  "It is admitted in the pleadings that a fox is a wild and noxious beast.")
...
(def both (assoc (accept (assert-arguments tompkins [a15 a16 a17])
                   facts2) :main-issue not-property))
; (view both)
