  ...
  (make-statement 
    ...
    :header (make-metadata 
              :description {:en "(4) Should certain categories of exceptions be made mandatory to ensure more legal 
                            ...
                            :de "(4) Sollten bestimmte Ausnahmekategorien verbindlich ausgestaltet werden, um ein 
                                 ...
                                 Ausnahmen besser zu schützen? [@GreenPaper, p. 6]"})
    :text {:en "Should certain categories of exceptions be made mandatory to ensure more legal 
           ...
           :de "Sollten bestimmte Kategorien von Ausnahmen zur Pflicht gemacht werden, um sicherzustellen, mehr Rechtssicherheit
                Sicherheit und einen besseren Schutz der Empfänger von Ausnahmen?"}))
...
(def harmonize-and-override 
  (make-statement 
    :text {:en "The permitted exceptions should be harmonised so that they are available in all Member States and
                Community laws should render void any contractual term purporting to eliminate an exception to copyright law."
           :de "Die zulässigen Ausnahmen sollten harmonisiert, so dass sie in allen Mitgliedstaaten sein und
                Gemeinschaftlichen Rechtsvorschriften sollte die Nichtigkeit einer Vertragsklausel, die angeblich eine Ausnahme im Urheberrecht zu beseitigen."}))
