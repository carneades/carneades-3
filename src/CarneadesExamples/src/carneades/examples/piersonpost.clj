...
(def a3 (make-argument
          :header (make-metadata :description {:en "JustinianÕs Institutes, lib. 2, tit. 1, s.13, and Fleta, lib. 3, c.2, p. 175, adopt the principle, that pursuit alone vests no property or right in the huntsman; and that even
...
(def a7 (make-argument 
          :header (make-metadata :description {:en "Puffendorf, lib. 4, c.6, s.2, and 10, deÞnes occupancy of beasts ferae naturae, to be
the actual corporal possession of them, and Bynkershoek is cited as coinciding in this deÞnition."})
...
(def a9 (make-argument 
          :header (make-metadata :description {:en "Barbeyrac, in his notes on Puffendorf ... afÞrms, that actual bodily seizure is not, in
