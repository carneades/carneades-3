...
;     ((_ x) (- x 1))))
 ...
 (define-syntax let-values*
   (syntax-rules ()
     ((_ bindings ...) (let*-values bindings ...))))
 ...
 (define-syntax assq-def
   (syntax-rules ()
     ((_ key alist) (or (assq key alist) (error "failed to assq key '" key "' in a list " alist)))
     ((_ key alist default-action-arg) (or (assq key alist)
                                           (let ((defact-symb (gensym)))
                                             (let ((defact-symb (car default-action-arg)))
                                               (if (procedure? defact-symb) (defact-symb) defact-symb)))))))
 ...
 (define-syntax assv-def
   (syntax-rules ()
     ((_ key alist) (or (assv key alist) (error "failed to assv key '" key "' in a list " alist)))
     ((_ key alist default-action-arg) (or (assv key alist)
                                           (let ((defact-symb (gensym)))
                                             (let ((defact-symb (car default-action-arg)))
                                               (if (procedure? defact-symb) (defact-symb) defact-symb)))))))
 ...
 (define-syntax assoc-def
   (syntax-rules ()
     ((_ key alist) (or (assoc key alist) (error "failed to assoc key '" key "' in a list " alist)))
     ((_ key alist default-action-arg) (or (assoc key alist)
                                           (let ((defact-symb (gensym)))
                                             (let ((defact-symb (car default-action-arg)))
                                               (if (procedure? defact-symb) (defact-symb) defact-symb)))))))
