...
(library
 ...
 (import
  ...
  (only (rnrs arithmetic fixnums) fxand))
...
;; (s char-set:s))
 ...
 (define char-set-rtd
   (make-record-type-descriptor 'char-set #f #f #f #f
                                '#((immutable s))))
 
 (define char-set-ctor-desc
   (make-record-constructor-descriptor char-set-rtd #f #f))
 
 (define make-char-set
   (record-constructor char-set-ctor-desc))
